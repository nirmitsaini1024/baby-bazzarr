...
export default function ShopPage() {
  ...
  // Show all products if no category is selected, or if the selected category matches any of our products
      ...
      <main className="flex-grow">
        ...
        <section className="bg-gray-100 py-12">
          <div className="container mx-auto px-4">
            <h1 className="text-4xl font-bold text-[#112938] mb-4">
              {t("shop_title")}
            </h1>
            <p className="text-lg text-gray-600">{t("shop_subtitle")}</p>
              ...
              <div className="w-full md:w-64 flex-shrink-0">
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  ...
                  <ul className="space-y-2">
                    <li>
                      <button
                        className={`w-full text-left py-1 ${category === null ? "text-[#0CC0DF] font-medium" : "text-gray-600 hover:text-[#0CC0DF]"}`}
                    ...
                    <li>
                      <button
                        className={`w-full text-left py-1 ${category === "furniture" ? "text-[#0CC0DF] font-medium" : "text-gray-600 hover:text-[#0CC0DF]"}`}
                    ...
                    <li>
                      <button
                        className={`w-full text-left py-1 ${category === "gear" ? "text-[#0CC0DF] font-medium" : "text-gray-600 hover:text-[#0CC0DF]"}`}
                        onClick={() => setCategory("gear")}
                      >
                        {language === "ar" ? "مستلزمات" : "Gear"}
                      </button>
                    </li>
                  </ul>
                </div>
        ...
        <div className="container mx-auto px-4">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link
                    href="/shop"
                    className="text-gray-300 hover:text-[#0CC0DF]"
                  >
          ...
          <div className="border-t border-gray-700 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex gap-4 mt-4 md:mt-0">
              <Link
                href="#"
                className="text-sm text-gray-400 hover:text-[#0CC0DF]"
              >
                {t("privacy_policy")}
              </Link>
              <Link
