...
export default function CartPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.address.trim()) {
      ...
      newErrors.address =
        language === "ar" ? "العنوان قصير جداً" : "Address is too short";
    }

    // Validate postal code (5 digits)
    if (!formData.postalCode.trim()) {
      newErrors.postalCode =
        language === "ar" ? "الرمز البريدي مطلوب" : "Postal code is required";
          ...
          <div className="container mx-auto px-4">
            {checkoutSuccess ? (
              <div className="bg-white p-8 rounded-lg shadow-sm text-center max-w-2xl mx-auto">
                ...
                <Button
                  asChild
                  className="bg-[#0CC0DF] hover:bg-[#0CC0DF]/90 text-white"
                >
                  <Link href="/my-orders">
                      ...
                      <div className="bg-white p-6 rounded-lg shadow-sm sticky top-24">
                        ...
                        <div className="space-y-3 mb-6">
                          ...
                          <div className="pt-3 mt-3 border-t flex justify-between">
                            ...
                            <span
                              className="font-bold text-[#112938]"
                              dir="ltr"
                            >
                              {total.toFixed(2)}{" "}
                              {language === "ar" ? "ج.م" : "EGP"}
